...
<head>
    ...
    <title>Forbidden | RA-ADMIN</title>
...
<body>
    <div class="error-container p-0">
        <div class="container text-center">
            <div>
                <div>
                    <img src="{{ asset('admin/images/background/error-403.png') }}" class="img-fluid" alt="403 Forbidden">
                </div>
                <div class="mb-3">
                    <div class="row">
                        <div class="col-lg-8 offset-lg-2">
                            <p class="text-secondary f-w-500">
                                {{ $exception->getMessage() ?: __('403 Forbidden: You do not have permission to access this resource.') }}
                            </p>
                        </div>
                    </div>
                </div>
