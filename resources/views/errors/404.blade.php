...
<head>
    ...
    <title>Not Found | RA-ADMIN</title>
...
<body>
    <div class="error-container p-0">
        <div class="container text-center">
            <div>
                <div>
                    <img src="{{ asset('admin/images/background/error-404.png') }}" class="img-fluid" alt="404 Not Found">
                </div>
                <div class="mb-3">
                    <div class="row">
                        <div class="col-lg-8 offset-lg-2">
                            <p class="text-secondary f-w-500">
                                {{ $exception->getMessage() ?: __('The page you are looking for might have been removed, had its name changed, or is temporarily unavailable.') }}
                            </p>
                        </div>
                    </div>
                </div>
