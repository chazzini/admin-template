                                    ...
                                    <ul class="search-list">
                                        <li class="search-list-item">
                                            ...
                                            <div class="search-list-content">
                                                <a href="#" target="_blank"><h6 class="mb-0 text-dark">user management</h6></a>
                                        ...
                                        <li class="search-list-item">
                                            ...
                                            <div class="search-list-content">
                                                <a href="#" target="_blank"><h6 class="mb-0 text-dark">data visualization</h6></a>
                                        ...
                                        <li class="search-list-item">
                                            ...
                                            <div class="search-list-content">
                                                <a href="#" target="_blank"><h6 class="mb-0 text-dark">security protocols</h6></a>
                                        ...
                                        <li class="search-list-item">
                                            ...
                                            <div class="search-list-content">
                                                <a href="#" target="_blank"><h6 class="mb-0 text-dark">authentication methods</h6></a>
                                        ...
                                        <li class="search-list-item">
                                            ...
                                            <div class="search-list-content">
                                                <a href="#" target="_blank"><h6 class="mb-0 f-s-16 text-dark">Data Table</h6></a>
                                                <p class="f-s-13 mb-0 text-secondary">#YE615</p>
                                            </div>
                                        </li>
                                    </ul>
                        ...
                        <div class="offcanvas offcanvas-end header-cart-canvas" tabindex="-1" id="cartcanvasRight"
                            ...
                            <div class="offcanvas-body app-scroll p-0">
                                <div class="head-container">
                                    <div class="head-box">
                                        <img src="{{ asset('admin/images/ecommerce/19.jpg') }}" alt="cart" class="h-50 me-3 b-r-10">
                                        <div class="flex-grow-1">
                                            <a class="mb-0 f-w-600 f-s-16" href="#" target="_blank"> Backpacks
                                            </a>
                                            <div>
                                    ...
                                    <!-- Simplified Cart Items for better clarity -->
                                </div>
                            </div>
                            <div class="offcanvas-footer">
                                <div class="head-box-footer p-3">
                                    ...
                                    <div class="header-cart-btn">
                                        <a href="#" target="_blank" role="button" class="btn btn-light-primary">
                                            <i class="ti ti-eye"></i> View Cart</a>
                                        <a href="#" target="_blank" role="button" class="btn btn-light-success">
                        ...
                        <div class="offcanvas offcanvas-end header-notification-canvas" tabindex="-1"
                            ...
                            <div class="offcanvas-body app-scroll p-0">
                                <div class="head-container">
                                    <div class="notification-message head-box">
                                        <div class="message-images">
                                            <span class="bg-secondary h-35 w-35 d-flex-center b-r-10 position-relative">
                                                <img src="{{ asset('admin/images/ai_avtar/6.jpg') }}" alt="" class="img-fluid b-r-10">
                                                <span
                                    ...
                                    <!-- Simplified Notifications for clarity -->
                                </div>
                            </div>
                        </div>
                    ...
                    <li class="header-profile">
                        <a href="#" class="d-block head-icon" role="button" data-bs-toggle="offcanvas"
                           data-bs-target="#profilecanvasRight" aria-controls="profilecanvasRight">
                            <img src="{{ asset('admin/images/avtar/woman.jpg') }}" alt="avtar" class="b-r-10 h-35 w-35">
                        </a>
                            ...
                            <div class="offcanvas-body app-scroll">
                                <ul class="">
                                    <li>
                                        <div class="d-flex-center">
                                            <span class="h-45 w-45 d-flex-center b-r-10 position-relative">
                                                <img src="{{ asset('admin/images/avtar/woman.jpg') }}" alt="" class="img-fluid b-r-10">
                                            </span>
                                        </div>
                                    ...
                                    <li>
                                        ...
                                        <a class="mb-0 text-danger" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
